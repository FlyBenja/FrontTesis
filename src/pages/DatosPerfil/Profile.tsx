...
const Profile = () => {
  return (
    <>
      <Breadcrumb pageName="Profile" /> {/* Aquí incluimos el Breadcrumb */}
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-32 md:h-48"> {/* Altura ajustada */}
          <img
            src={ofiLogo}
            alt="profile cover"
        ...
        <div className="px-4 pb-1 text-center lg:pb-3 xl:pb-4"> {/* Padding ajustado */}
          <div className="relative z-30 mx-auto -mt-16 h-24 w-24 sm:h-36 sm:w-36 sm:-mt-20 rounded-full bg-white/20 p-1 backdrop-blur sm:p-2"> {/* Tamaños ajustados */}
            <img src={userSix} alt="profile" className="w-full h-full rounded-full" />
          </div>
          <div className="mt-1"> {/* Margen superior ajustado */}
