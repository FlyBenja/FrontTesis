...
const UploadProfessors: React.FC = () => {
  // State variables to manage selected file, API loading status, and headquarterId
  const [fileSelected, setFileSelected] = useState<File | null>(null)
  const [apiLoading, setApiLoading] = useState<boolean>(false)
  const [headquarterId, setHeadquarterId] = useState<number | null>(null)
  const fileInputRef = React.createRef<HTMLInputElement>()

  // Fetch headquarterId from user profile on component mount
  useEffect(() => {
          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="p-6.5">
              ...
              <button
                ...
                disabled={!fileSelected || !headquarterId}
              >
                Confirmar Subida
              </button>
