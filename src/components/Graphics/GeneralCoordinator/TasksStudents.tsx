...
const TasksStudents: React.FC = () => {
  ...
  const [courseId, setCourseId] = useState<number>(() => {
    ...
    return month <= 6 ? 1 : 2 // PG1 si está entre enero-junio, PG2 si es julio-diciembre
  })
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const stats = await getTaskStats(courseId, currentYear, Number(selectedSede))
