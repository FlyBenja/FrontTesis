        ...
        driverObj.setSteps([
            {
                ...
                popover: {
                    ...
                    description: 'Aquí puedes ver todas las solicitudes de revisión asignadas a ti como coordinador.',
                    side: 'bottom',
                    align: 'start',
                },
            },
            {
                ...
                popover: {
                    ...
                    description: 'Haz clic para alternar entre orden ascendente y descendente en la tabla.',
                    side: 'bottom',
                    align: 'start',
                },
            },
            {
                ...
                popover: {
                    title: 'Ver Detalle',
                    description: 'Haz clic aquí para ver más detalles sobre la solicitud seleccionada.',
                    side: 'top',
                    align: 'start',
                },
            },
...
export default TourMyAssignments;
