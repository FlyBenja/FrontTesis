...
/**
 * Props for the ActivateThesisCoordinator component.
 */
interface ActivateThesisCoordinatorProps {
  enabled: boolean;
  onChange: () => void;
...
/**
 * ActivateThesisCoordinator is a toggle switch component that represents a binary on/off state.
 ...
 *
 */
const ActivateThesisCoordinator: React.FC<ActivateThesisCoordinatorProps> = ({ enabled, onChange, uniqueId }) => {
  return (
    <div>
...
export default ActivateThesisCoordinator;
