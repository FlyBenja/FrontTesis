...
import { getDetalleTareas } from '../../ts/Administrator/GetTaskDetails'; // Ajusta el path según donde tengas la API
import { getDatosPerfil, PerfilData } from '../../ts/General/GetProfileData'; // Ajusta el path según corresponda
