...
import { asignaRevisor } from '../../../ts/CoordinadorTesis/AsignaRevisor';
import { getRevisores } from '../../../ts/CoordinadorTesis/GetRevisores'; // Importar la función para obtener los revisores
